...
export function HorizontalBookCarousel({
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={scrollerRef}
        className="flex snap-x snap-mandatory gap-5 overflow-x-auto px-6 pb-2 [scroll-padding-inline:2rem] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden [&>[data-front='true']]:z-10 [&>[data-front='true']]:-translate-y-1 [&>[data-front='true']]:scale-[1.1] [&>[data-front='true']]:animate-[mobileSpotlight_650ms_ease-out] [&>[data-front='true']_a]:shadow-[0_0_0_2px_rgba(125,211,252,0.85),0_0_64px_-6px_rgba(56,189,248,1)] [&>[data-front='true']_a_video]:shadow-[inset_0_0_28px_rgba(56,189,248,0.35),0_0_34px_-14px_rgba(56,189,248,0.95)] [&>[data-front='true']_a_img]:shadow-[inset_0_0_28px_rgba(56,189,248,0.35),0_0_34px_-14px_rgba(56,189,248,0.95)] sm:[&>[data-front='true']]:translate-y-0 sm:[&>[data-front='true']]:scale-100 sm:[&>[data-front='true']]:animate-none sm:[&>[data-front='true']_a]:shadow-none sm:[&>[data-front='true']_a_video]:shadow-none sm:[&>[data-front='true']_a_img]:shadow-none sm:px-8 [@keyframes_mobileSpotlight{0%{transform:translateY(0)_scale(1)}55%{transform:translateY(-0.5rem)_scale(1.12)}100%{transform:translateY(-0.25rem)_scale(1.1)}}]"
      >
