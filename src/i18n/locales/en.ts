...
const en = {
  ...
  book: {
    ...
    previewNotAdded: "The author hasn't added a reader preview for this book yet.",
    backCoverLabel: "Back cover",
    freeSampleNote: "Free sample · the full book requires purchase.",
  },
  checkout: {
    successMetaTitle: "Payment successful",
    successTitle: "Payment successful",
    successDesc:
      "Thank you for supporting independent authors. Your purchase is confirmed and the author has been credited.",
    accessGrantedTitle: "Access granted",
    accessGrantedDesc:
      "Your book has been added to your reader library. Sign in with the same email you purchased with to open and download it any time.",
    orderReference: "Order reference",
    goToLibrary: "Go to your library →",
    backToMarketplace: "Back to marketplace",
    cancelMetaTitle: "Payment canceled",
    ...
    changedMindDesc:
      "Your cart wasn't saved, but the book is still available. Head back to try again.",
  ...
  reader: {
    metaLibraryTitle: "My ReaderChain Library",
    metaBookTitle: "My book",
    libraryTitle: "My ReaderChain Library",
    signedInAs: "Signed in as",
    purchasedBooksCountOne: "1 purchased book",
    purchasedBooksCountMany: "{count} purchased books",
    noBooksTitle: "You do not have any books in your ReaderChain Library yet.",
    noBooksDesc:
      "Access is granted right after you buy a book. Your purchases will appear here automatically.",
    explore: "Explore ReaderChain",
    details: "Details →",
    download: "Download",
    access: "Access:",
    accessActive: "Active",
    accessRefunded: "Refunded",
    accessRevoked: "Revoked",
    readTitle: "Read your book",
    readPrivateNote: "Your download is private to your account.",
    downloadManuscript: "Download manuscript",
    accessState: "Access to this book is",
    browserReaderLater:
      "In-browser reading arrives in a later phase. Files stay private to your library.",
    proofTitle: "Proof of authorship",
    proofDesc: "This book's authorship is registered on Base Sepolia.",
    contract: "Contract",
    transaction: "Transaction",
    areaLabel: "Reader area",
    role: "Reader",
  },
  login: {
    metaTitle: "Sign in",
